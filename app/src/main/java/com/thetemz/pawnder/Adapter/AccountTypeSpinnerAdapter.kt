...
class AccountTypeSpinnerAdapter (val context: Context, var dataSource: AccountTypeResModel) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = dataSource.data.get(position).accountName
/*
