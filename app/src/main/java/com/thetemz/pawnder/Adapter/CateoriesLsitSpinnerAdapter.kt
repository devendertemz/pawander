...
class CateoriesLsitSpinnerAdapter (val context: Context, var dataSource: CategorylistData) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = dataSource.data.get(position).categoryName
/*
